    ...
    public void changeConfig(EmailConfig emailConfig, Integer companyID, Integer claimType){
        ...
        if(companyID == 1){
            if(claimType != null && claimType == 1){
                emailConfig.setFrom(BottomUpProperties.INSTANCE.getProperty("noreply.mail.from"));
                emailConfig.setFromName(BottomUpProperties.INSTANCE.getProperty("noreply.mail.from.name"));
                emailConfig.setHost(BottomUpProperties.INSTANCE.getProperty("noreply.mail.host"));
                emailConfig.setPort(BottomUpProperties.INSTANCE.getProperty("noreply.mail.port"));
                emailConfig.setUsername(BottomUpProperties.INSTANCE.getProperty("noreply.mail.username"));
                emailConfig.setPassword(BottomUpProperties.INSTANCE.getProperty("noreply.mail.password"));
            }else{
                emailConfig.setFrom(BottomUpProperties.INSTANCE.getProperty("noreply.admin.mail.from"));
                emailConfig.setFromName(BottomUpProperties.INSTANCE.getProperty("noreply.admin.mail.from.name"));
                emailConfig.setHost(BottomUpProperties.INSTANCE.getProperty("noreply.admin.mail.host"));
                emailConfig.setPort(BottomUpProperties.INSTANCE.getProperty("noreply.admin.mail.port"));
                emailConfig.setUsername(BottomUpProperties.INSTANCE.getProperty("noreply.admin.mail.username"));
                emailConfig.setPassword(BottomUpProperties.INSTANCE.getProperty("noreply.admin.mail.password"));
            }
        }
    }
}
