...
public class HistoryController extends BaseController {
    ...
    @ResponseBody
    public HistoryData getByID(@PathVariable("historyID") String historyID, HttpServletRequest request) throws BottomUpException {
        return this.historyService.getByID(historyID);
    }
