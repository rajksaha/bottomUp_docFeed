...
public class LoginController extends BaseController{
    ...
    @ResponseBody
    public Map<String, Object> sendResetPasswordMail(@RequestBody UserData userData, HttpServletRequest request, HttpServletResponse response) throws BottomUpException {
    ...
    @ResponseBody
    public Map<String, Object> updateUserPasswordByKey(@RequestBody UserData userData) throws BottomUpException {
